namespace CorruptOSBot.Helpers
{
    ...
    {
        public const string CoxLearner = "CoX Learner";
        public const string TobLearner = "ToB Learner";
        ...
        public const string CM = "Cox Challenge Mode";
        public const string HMT = "Tob Hard Mode";
        public const string GWD = "GWD";
        public const string Corp = "Corp";
        public const string Nex = "Nex";
        public const string TOA = "ToA";
        public const string Nightmare = "Nightmare";
        public const string WildyBosses = "Wildy Bosses";
        ...
        public const string CoxImage = "https://oldschool.runescape.wiki/images/thumb/Chambers_of_Xeric_artwork.jpg/1920px-Chambers_of_Xeric_artwork.jpg?090e1";
        ...
        public const string NexImage = "https://pbs.twimg.com/media/EY3Ra-BWAAEcIce?format=jpg&name=orig";
        public const string ToAImage = "https://oldschool.runescape.wiki/images/Ba-Ba_encounter_artwork.jpg?1e5f5";
        public const string WildyBossesImage = "https://pbs.twimg.com/media/DH-zxf-UAAAz0VI.jpg?format=jpg&name=orig";

...
namespace CorruptOSBot.Modules
{
    public class KcModule : ModuleBase<SocketCommandContext>
    {
        ...
        //    {
        //        if (ToggleStateManager.GetToggleState("kc", Context.User) && RoleHelper.HasAnyRole(Context.User))
        //        {
        ...
        //    else
        //    {
        //        await DiscordHelper.NotAllowedMessageToUser(Context, "!kc", "pvm-general");
        //    }
        ...
        //            { EmojiHelper.GetFullEmojiString(EmojiEnum.gauntlet.ToString()), clanMember.latestSnapshot.the_gauntlet.kills },
        ...
        //            { EmojiHelper.GetFullEmojiString(EmojiEnum.corruptgauntlet.ToString()), clanMember.latestSnapshot.the_corrupted_gauntlet.kills },
